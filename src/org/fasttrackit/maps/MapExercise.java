...
public class MapExercise {
 ...
 //       nameToAge.put("Alex", 40);
        ...
        System.out.println("Execution time in millies: " + time1);
        System.out.println("Execution time in millies: " + time2);

        Map<String, List<Integer>> studentGrades = new HashMap<>();
        addGradeForStudent(studentGrades, "Ionut", 10);
        addGradeForStudent(studentGrades, "Ionut", 9);
